...
public class SeasonAttrRanker implements AttributeRanker<SeasonAttribute> {
  ...
  static {
    SeasonEnum[] fallMappings = {SeasonEnum.FALL, SeasonEnum.SPRING};
    SeasonEnum[] springMappings = {SeasonEnum.SPRING, SeasonEnum.FALL,
            SeasonEnum.WINTER};
    SeasonEnum[] winterMappings = {SeasonEnum.WINTER, SeasonEnum.FALL,
            SeasonEnum.SPRING};
    SeasonEnum[] summerMappings = {SeasonEnum.SUMMER, SeasonEnum.SPRING};
